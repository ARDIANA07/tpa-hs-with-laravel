    ...
    <main class="main">
        ...
        <section id="hero" class="hero section">
            ...
            <div class="container text-center">
                <div class="d-flex flex-column justify-content-center align-items-center">
                    <h1 data-aos="fade-up">Selamat datang di <span>Website TPA Hidayatus Shibyan Karangkunti</span></h1>
                    <p data-aos="fade-up" data-aos-delay="100">TPA Hidayatus Shibyan berdiri pada tahun tanggal 12 juli
                        1990<br></p>
                    <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
                        <a href="https://youtu.be/NFShP4GqLq4"
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-xl-4 col-lg-6" data-aos="fade-up" data-aos-delay="300">
                        <div class="service-item d-flex">
                            ...
                            <div>
                                <h4 class="title"><a href="#" class="stretched-link">Sed ut
                                        perspiciatis</a></h4>
        ...
        <section id="about" class="about section">
            ...
            <div class="container">
                ...
                <div class="row gy-3 d-flex">
                    <div class="col-l-2 col-md-3 col-3">
                        <img src="{{ asset('assets/img/tpa.JPG') }}" alt="" style="width: 100%"
                            class="p-2 img-fluid"><br>
                    </div>
                    <div class="col-l-2 col-md-3 col-3">
                        <img src="{{ asset('assets/img/tpa.JPG') }}" alt="" style="width: 100%"
                            class="p-2 img-fluid"><br>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="500">
                        <div class="service-item item-indigo position-relative">
                            ...
                            <div>
                                ...
                                <p>Cumque et suscipit saepe. Est maiores autem enim facilis ut aut ipsam corporis
                                    aut. Sed animi at autem alias eius labore.</p>
                                <a href="#" class="read-more stretched-link">Learn More <i
                                        class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-6" data-aos="fade-up" data-aos-delay="600">
                        <div class="service-item item-pink position-relative">
                            ...
                            <div>
                                ...
                                <p>Hic molestias ea quibusdam eos. Fugiat enim doloremque aut neque non et debitis
                                    iure. Corrupti recusandae ducimus enim.</p>
                                <a href="#" class="read-more stretched-link">Learn More <i
                                        class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="100">
                        <div class="pricing-item">
                            <h3>Free Plan</h3>
                            <p class="description">Ullam mollitia quasi nobis soluta in voluptatum et sint palora
                                dex strater</p>
                            ...
                            <ul>
                                ...
                                <li class="na"><i class="bi bi-x"></i> <span>Massa ultricies mi quis
                                        hendrerit</span></li>
                                <li class="na"><i class="bi bi-x"></i> <span>Voluptate id voluptas qui sed
                                        aperiam rerum</span></li>
                                <li class="na"><i class="bi bi-x"></i> <span>Iure nihil dolores recusandae
                                        odit voluptatibus</span></li>
                            </ul>
                        </div>
        ...
        <section id="testimonials" class="testimonials section light-background">
            ...
            <div class="container section-title" data-aos="fade-up">
                ...
                <p>TPA Hidayatus Shibyan sudah mencetuskan banyak alumni yang luar biasa</p>
            </div><!-- End Section Title -->
